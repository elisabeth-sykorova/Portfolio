...
let component_cache;
export const component = async () => component_cache ??= (await import('../entries/pages/visualclock/_page.svelte.js')).default;
...
export const stylesheets = ["_app/immutable/assets/3.BBoIufgx.css","_app/immutable/assets/TableOfContents.BC5qEExz.css"];
export const fonts = [];
