...
<div class="page-layout">
    <div id="content">
        ...
        <a href='https://github.com/elisabeth-sykorova/SaveGregor' class='gh-link' target="_blank"><img src='{base}/images/github.png' alt='github logo' class='gh'>Project Repository</a>
